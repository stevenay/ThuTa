package com.padc.interactive_training.views.items;
...
/**
 * Created by NayLinAung on 9/3/2016.
 */
public class LoadingCourseItemView extends FrameLayout {
    ...
    public LoadingCourseItemView(Context context) {
        super(context);
        init();
    }

    public LoadingCourseItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LoadingCourseItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LoadingCourseItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.item_my_course_loader, this, true);
