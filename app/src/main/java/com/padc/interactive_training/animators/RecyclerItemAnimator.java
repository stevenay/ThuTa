package com.padc.interactive_training.animators;
...
public class RecyclerItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == MyCourseAdapter.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((MyCourseViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final MyCourseViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            MyCourseViewHolder holder = (MyCourseViewHolder) newHolder;

            animateHeartButton(holder);
            // TODO
            //updateLikesCounter(holder, holder.getFeedItem().likesCount);
            if (MyCourseAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final MyCourseViewHolder holder) {
    ...
    private void updateLikesCounter(MyCourseViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final MyCourseViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(MyCourseViewHolder holder) {
    ...
    private void resetLikeAnimationState(MyCourseViewHolder holder) {
